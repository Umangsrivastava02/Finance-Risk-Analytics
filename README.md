...
### 🗄️ SQL Queries
<details>
  <summary>Click to view all 25 SQL business questions solved</summary>
...
### 🐍 Python Analysis
<details>
  <summary>Click to view all Python visualization tasks</summary>
...
## 📁 Dataset Details
The analysis uses a simulated personal finance dataset with information on:
- **Demographics**: Age, Gender, Marital Status, Profession, Region
- **Income & Debt**: Monthly Income, Credit Score, EMIs, Outstanding Loans
- **Expenses & Savings**: Category spending (Food, Rent, Utilities, Entertainment, etc.), Savings rate, Investment preferences
...
### Prerequisites
- **Database**: MS SQL Server (or any SQL-compatible DBMS)
- **Python**: Version 3.8+ with Jupyter Notebook installed

### Installation & Run Instructions
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Umangsrivastava02/personal-finance-analytics.git
   ```
2. **Database Setup (SQL)**:
   - Import your personal finance dataset into your SQL Server instance.
   - Run the query file `personal_finance.sql` to execute the database analysis.
3. **Visualization & Analytics (Python)**:
   ...
   - Open and run the Jupyter notebook:
     ```bash
     jupyter notebook personal_finance.ipynb
     ```
